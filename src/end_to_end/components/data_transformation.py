...
import os
from src.end_to_end.utils import save_object
...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        try:
            ...
            logging.info(
                f"Numerical columns: {numerical_columns} and categorical columns: {categorical_columns}"
            )
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            test_arr = np.c_[input_feature_test_array, np.array(target_column_test_df)]
